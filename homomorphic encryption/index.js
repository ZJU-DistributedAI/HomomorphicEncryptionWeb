...
import { INITIALIZER_IDENTIFIER_REGISTRY_SYMBOL_MAP } from '@tensorflow/tfjs-layers/dist/initializers';
...
async function predict_result(){
  ui.logStatus('show_preidct_result',8);
}
async function get_model(){
  ui.logStatus('show_model','Get model from success!');
}

async function train_model(){
  ui.logStatus('show_process','Training Model...')
}


async function init_model(){
  var w_model=mh.generate_random_matrix_float(784,32,1)
  var w2_model=mh.generate_random_matrix_float(32,10,1)
  var b_model=mh.generate_random_matrix_float(32,1,1)
  var b2_model=mh.generate_random_matrix_float(10,1,1)
  ui.logStatus('init_model_result_w1','w1_model:\n'+w_model)
  ui.logStatus('init_model_result_w2','w2_model:\n'+w2_model)
  ui.logStatus('init_model_result_b1','b_model:\n'+b_model)
  ui.logStatus('init_model_result_b2','b2_model:\n'+b2_model)
}

async function check_current_model(){

  var w_model=mh.generate_random_matrix_float(784,32,10)
  var w2_model=mh.generate_random_matrix_float(32,10,10)
  var b_model=mh.generate_random_matrix_float(32,1,10)
  var b2_model=mh.generate_random_matrix_float(10,1,10)
  ui.logStatus('check_current_w1_result','w1_model:\n'+w_model)
  ui.logStatus('check_current_w2_result','w2_model:\n'+w2_model)
  ui.logStatus('check_current_b1_result','b_model:\n'+b_model)
  ui.logStatus('check_current_b2_result','b2_model:\n'+b2_model)
}
...
ui.predictResultCallback(async ()=>{
  await predict_result();
});

ui.getModelCallback(async ()=>{
  await get_model();
});

ui.trainModelCallback(async ()=>{
  await train_model();
});

ui.initModelCallback(async ()=>{
  await init_model()
})

ui.checkCurrentModelCallback(async ()=>{
  await check_current_model()
})
